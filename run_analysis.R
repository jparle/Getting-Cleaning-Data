...
setwd('/Volumes//TOSHIBA EXT/Data Science//Courses/Getting & Cleaning Data')

# Step1. Merges the training and the test sets to create one data set.
trainData <- read.table("./Project/UCI HAR Dataset/train/X_train.txt")
...
testData <- read.table("./Project/UCI HAR Dataset/test/X_test.txt")
